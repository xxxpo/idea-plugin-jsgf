...
public class JsgfSlopStringImpl extends ASTWrapperPsiElement implements JsgfSlopString {

  public JsgfSlopStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JsgfVisitor visitor) {
    visitor.visitSlopString(this);
  }
  ...
  @Override
  @NotNull
  public List<JsgfSlopString> getSlopStringList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JsgfSlopString.class);
  }
